        ...
        <main className="p-5 sm:p-8">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <AgentCard agent={activeHousehold.personalAgent} household={false} />
            </div>
        ...
        <div className="mx-auto flex min-h-[calc(100dvh-3rem)] max-w-6xl flex-col">
          ...
          <div className="my-auto max-w-3xl py-16">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              ...
              Agents, and manage the people, rooms, apps, and privacy that belong
              to your home.
            </p>
            <Button
              asChild
      ...
      <main className="flex min-h-dvh items-center justify-center bg-slate-50 p-6">
        <div className="w-full max-w-xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Continue the Personal-Agent onboarding flow to create or recover your
            Household, name its Household Agent, name My Agent, and review Apps
            &amp; Services.
          </p>
          <Button
            asChild
